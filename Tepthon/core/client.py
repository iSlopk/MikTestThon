...
ZDEV = (1332671807, 6454554515, 315153481)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @ASX16\
                                  \n\n--------بـدء تتبـع سجـل ميكثـون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ميكثـون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻--------"
                        ...
                        link = "[Mik](https://t.me/ASX16)"
                        text = (
                            "**✘ تقـريـر اشعـار ميكثـون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ميكثـون 𝗠𝗶𝗸𝘁𝗵𝗼𝗻 ✘**\n\n "
                        link = "[Mik](https://t.me/ASX16)"
