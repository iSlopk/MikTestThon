...
#< https://t.me/ZThon >
# This file is a part of < https://github.com/Zed-Thon/MikthonAL/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/Zed-Thon/MikthonAL/blob/master/LICENSE/>.
...
from Mikthon import BOTLOG, BOTLOG_CHATID, PM_LOGGER_GROUP_ID
...
async def autoname(): #Code by T.me/zzzzl1l
    ...
    MikthonAL = await bot.get_me()
    zzname = f"{MikthonAL.first_name} {MikthonAL.last_name}" if MikthonAL.last_name else f"{MikthonAL.first_name}"
    tz = Config.TZ
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/logs.jpg")
        _, groupid = await create_supergroup(
            "سجـل ميكثـون", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/Takhzeen.jpg")
        _, groupid = await create_supergroup(
            "مجمـوعة الخزن (التخزين)", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
